function [cost,capacity,emission] = houston_flat(colocate,T,IP,PP,OP,C,CO2_grid,a,au,con,BS,A,S,E,PUE,solar,range1,RC,RE,SR,range2,CRC,CRE,P,GP,RP,BP,plt,location)
