function [cost,capacity,emission,status] = houston_emission(T,IP,PP,OP,C,CO2_grid,a,au,con,BS,A,S,E,PUE,solar,range1,RC,RE,SR,range2,CRC,CRE,P,GP,RP,BP,plt,location)
...
capacity = [PV, GE];
emission = [24*365/T*sum(RE*PV*solar'), 24*365/T*sum(CRE*G)];
%{
