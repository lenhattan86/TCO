...
% net-zero, PV
[cost_real,capacity_real,emission_real] = houston_grid(0,1,0,0,T,IP,PP,OP,IT,CO2_grid,a,au,con,BS,A,S,E,bu,PUE,R(1,:),[0,1000],RC,RE,SR,[0,0],[1000/20+SR*200/4, 0.005+0.06],CRE,P,GP,RP,BP,plot_option,'results\tmp');
...
total_cost_real = yearly_cost_real*max_payback + infra_cost_real;
cost_reduction_real = 1- total_cost_real/total_cost_grid
